...
**Shipped version:** 5.4.19~ynh1 *(:warning: This is the `ci-auto-update-v5.4.19` branch. The [`master` branch](https://github.com/YunoHost-Apps/fab-manager_ynh/tree/master) used in the catalog is currently on version 5.4.4\~ynh1.)*
