...
**Version incluse :** 5.4.19~ynh1 *(:warning: Il s'agit de la branche `ci-auto-update-v5.4.19`. La [branche `master`](https://github.com/YunoHost-Apps/fab-manager_ynh/tree/master) utilisée dans le catalogue est actuellement en 5.4.4\~ynh1.)*
